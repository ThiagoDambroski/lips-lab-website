...
export const glitterOptions: GlitterColor[] = [
...
export const baseBatom: { id: BaseOptions, name: string, description: string }[] = [
  {
    id: "matte",
    name: "MATTE",
    description:
...
export const baseGloss: { id: BaseOptions, name: string, description: string }[] = [
  {
    id: "CLASSICO",
    name:"CLÁSSICO",
...
export const smellOptions: { id: SmelltOptions, name: string, img: string }[] = [
...
export const eyesOptions: { id: EyeColorOptions; img: string }[] = [
...
export const skinOptions: { id: SkinToneOptions; img: string }[] = [
...
export const hairOptions: { id: HairColorOptions; img: string }[] = [
...
export const allEsence: { id: EsenceOptions, name: string, img: string }[] = [
  {
